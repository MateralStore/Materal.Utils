...
public interface ICacheHelper
{
    ...
    void SetBySliding(string key, object content, double timer, DateTimeUnit dateTimeType);
    /// <summary>
    /// 设置缓存(只要有访问就会延时)
    /// </summary>
    /// <param name="key">键</param>
    ...
    /// <param name="timer">时间值</param>
    /// <param name="dateTimeType">时间类型</param>
    void SetByAbsolute(string key, object content, double timer, DateTimeUnit dateTimeType);
    /// <summary>
    /// 设置缓存(绝对时间)
    /// </summary>
    /// <param name="key">键</param>
