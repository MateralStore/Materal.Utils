namespace Materal.Utils.Model
{
    ...
    public class ResultModel
    {
        ...
        /// <returns></returns>
        public static ResultModel Waring(string? message = null) => new(ResultTypeEnum.Waring, message);
    }
    /// <summary>
    /// 返回模型
    /// </summary>
    ...
    public class ResultModel<T> : ResultModel
    {
        ...
        public static ResultModel<T> Waring(T data, string? message = null) => new(ResultTypeEnum.Waring, data, message);
        /// <summary>
        /// 获得一个警告返回对象
        /// </summary>
        /// <param name="message">返回消息</param>
        /// <returns>警告返回对象</returns>
        public new static ResultModel<T> Waring(string? message = null) => new(ResultTypeEnum.Waring, default, message);
    }
}
