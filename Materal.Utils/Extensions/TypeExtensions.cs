...
public static class TypeExtensions
{
    ...
    public static object GetEnumByDescription(this Type type, string description)
    {
        ...
        throw new UtilException("未找到该描述的枚举");
    }
    #region 类型实例化
    /// <summary>
    /// 实例化对象
    ...
    public static object? InstantiationOrDefault(this Type type, object[]? args = null)
    {
        ...
        {
            Type[] argTypes = [.. args.Select(m => m.GetType())];
    ...
    public static object Instantiation(this Type type, object[]? args = null)
        => type.InstantiationOrDefault(args) ?? throw new UtilException("实例化失败");
    /// <summary>
    /// 实例化对象
    /// </summary>
    /// <param name="type"></param>
    ...
    public static object Instantiation(this Type type, IServiceProvider serviceProvider, object[]? args = null)
        => type.InstantiationOrDefault(serviceProvider, args) ?? throw new UtilException("实例化失败");
    /// <summary>
    /// 实例化对象
    /// </summary>
    /// <param name="type"></param>
    ...
    public static T Instantiation<T>(this Type type, object[]? args = null)
        => type.InstantiationOrDefault<T>(args) ?? throw new UtilException("实例化失败");
    /// <summary>
    /// 实例化对象
    /// </summary>
    /// <param name="type"></param>
    ...
    public static T Instantiation<T>(this Type type, IServiceProvider serviceProvider, object[]? args = null)
        => type.InstantiationOrDefault<T>(serviceProvider, args) ?? throw new UtilException("实例化失败");
    #endregion
    /// <summary>
    /// 是否可作为类型使用
    /// </summary>
    ...
    /// <param name="type"></param>
    /// <returns></returns>
    public static List<Type> GetAllInterfaces(this Type type) => [.. GetAllInterfaces(type.GetInterfaces())];
    /// <summary>
    /// 获得所有接口
    /// </summary>
