...
public static class TypeHelper
{
    ...
    /// <param name="assemblies"></param>
    /// <returns></returns>
    public static Type? GetTypeByTypeFullName<T>(string typeName, Type[] argTypes, Assembly[]? assemblies = null) => GetTypeByTypeName(typeName, typeof(T), argTypes, assemblies);
    /// <summary>
    /// 获得类型
    /// </summary>
    /// <typeparam name="T">父级类型</typeparam>
