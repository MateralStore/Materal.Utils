...
public class CollectionResultModel<T> : ResultModel
{
    ...
    public CollectionResultModel(ResultType resultType, ICollection<T>? data, string? message = null) : base(resultType, message)
    {
        Data = data;
    }
    /// <summary>
    ...
    /// <param name="message">返回消息</param>
    public CollectionResultModel(ResultType resultType, ICollection<T>? data, PageModel pageModel, string? message = null) : base(resultType, message)
    {
        Data = data;
        PageModel = pageModel;
    ...
    /// <param name="message">返回消息</param>
    public CollectionResultModel(ResultType resultType, ICollection<T>? data, RangeModel rangeModel, string? message = null) : base(resultType, message)
    {
        Data = data;
    ...
    public static CollectionResultModel<T> Success(ICollection<T> data, PageModel pageModel, string? message = null)
        => new(ResultType.Success, data, pageModel, message);
    /// <summary>
    /// 成功
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Success(ICollection<T> data, PageRequestModel pageRequestModel, int dataCount, string? message = null)
        => new(ResultType.Success, data, new PageModel(pageRequestModel, dataCount), message);
    /// <summary>
    /// 失败
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Fail(ICollection<T> data, PageModel pageModel, string? message = null)
        => new(ResultType.Fail, data, pageModel, message);
    /// <summary>
    /// 失败
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Fail(ICollection<T> data, PageRequestModel rangeRequestModel, int dataCount, string? message = null)
        => new(ResultType.Fail, data, new PageModel(rangeRequestModel, dataCount), message);
    /// <summary>
    /// 警告
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Success(ICollection<T> data, RangeModel rangeModel, string? message = null)
        => new(ResultType.Success, data, rangeModel, message);
    /// <summary>
    /// 成功
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Success(ICollection<T> data, RangeRequestModel rangeRequestModel, int dataCount, string? message = null)
        => new(ResultType.Success, data, new RangeModel(rangeRequestModel, dataCount), message);
    /// <summary>
    /// 失败
    /// </summary>
    /// <param name="message">返回消息</param>
    /// <returns></returns>
    public new static CollectionResultModel<T> Fail(string? message = null) => new(ResultType.Fail, null, message);
    /// <summary>
    /// 失败
    /// </summary>
    /// <param name="data">返回数据对象</param>
    ...
    public static CollectionResultModel<T> Fail(ICollection<T> data, RangeRequestModel rangeRequestModel, int dataCount, string? message = null)
        => new(ResultType.Fail, data, new RangeModel(rangeRequestModel, dataCount), message);
    /// <summary>
    /// 警告
    /// </summary>
    /// <param name="data">返回数据对象</param>
