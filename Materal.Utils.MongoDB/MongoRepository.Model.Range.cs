...
public partial class MongoRepository<T>
{
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, skip, take);
        List<T> data = await cursor.ToListAsync();
        long dataCount = await CountAsync(filter);
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, skip, take);
        List<T> data = cursor.ToList();
        long dataCount = Count(filter);
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, rangeRequestModel);
        List<T> data = await cursor.ToListAsync();
        long dataCount = await CountAsync(filter);
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, rangeRequestModel);
        List<T> data = cursor.ToList();
        long dataCount = Count(filter);
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, skip, take);
        List<T> data = await cursor.ToListAsync();
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
        IAsyncCursor<T> cursor = RangeCursor(filter, skip, take);
        List<T> data = cursor.ToList();
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, rangeRequestModel);
        List<T> data = await cursor.ToListAsync();
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, rangeRequestModel);
        List<T> data = cursor.ToList();
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(RangeRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual (List<T> data, RangeModel rangeInfo) Range(RangeRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
