...
public partial class MongoRepository<T>
{
    ...
    /// <returns></returns>
    public virtual async Task<T> FirstAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T First(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<T> FirstAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, 0, 1);
        T result = await cursor.FirstAsync();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T First(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, 0, 1);
        T result = cursor.First();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<T> FirstAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T First(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<T?> FirstOrDefaultAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, 0, 1);
        T? result = await cursor.FirstOrDefaultAsync();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T? FirstOrDefault(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, 0, 1);
        T? result = cursor.FirstOrDefault();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<T?> FirstOrDefaultAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filter, sort, sortOrder, 0, 1);
        T? result = await cursor.FirstOrDefaultAsync();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T? FirstOrDefault(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = RangeCursor(filter, sort, sortOrder, 0, 1);
        T? result = cursor.FirstOrDefault();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<T?> FirstOrDefaultAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = await RangeCursorAsync(filterModel, sort, sortOrder, 0, 1);
        T? result = await cursor.FirstOrDefaultAsync();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual T? FirstOrDefault(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = RangeCursor(filterModel, sort, sortOrder, 0, 1);
        T? result = cursor.FirstOrDefault();
        return result;
