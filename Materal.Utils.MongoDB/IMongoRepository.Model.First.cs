...
public partial interface IMongoRepository<T>
{
    ...
    /// <returns></returns>
    Task<T> FirstAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T First(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<T> FirstAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T First(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<T> FirstAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T First(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<T?> FirstOrDefaultAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T? FirstOrDefault(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<T?> FirstOrDefaultAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T? FirstOrDefault(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<T?> FirstOrDefaultAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询第一条数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    T? FirstOrDefault(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
}
