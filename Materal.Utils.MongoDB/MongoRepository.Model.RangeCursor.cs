...
public partial class MongoRepository<T>
{
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    private static FindOptions<T, T> GetRangeFindOptions(Expression<Func<T, object>> sortExpression, SortOrder sortOrder, int skip, int take) => new() { Sort = GetSortDefinition(sortExpression, sortOrder), Skip = GetSkip(skip), Limit = GetLimit(take) };
    /// <summary>
    /// 查询范围数据
    /// </summary>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
        => await FindCursorAsync(filter, GetRangeFindOptions(sort, sortOrder, skip, take));
    /// <summary>
    /// 查询范围数据
    /// </summary>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
        => FindCursor(filter, GetRangeFindOptions(sort, sortOrder, skip, take));
    /// <summary>
    /// 查询范围数据
    /// </summary>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<IAsyncCursor<T>> RangeCursorAsync(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual IAsyncCursor<T> RangeCursor(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        FilterDefinition<T> filter = filterModel.GetSearchFilterDefinition<T>();
