...
public partial class MongoRepository<T>
{
    ...
    /// <returns></returns>
    public virtual async Task<List<T>> FindAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual List<T> Find(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<List<T>> FindAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = await FindCursorAsync(filter, sort, sortOrder);
        List<T> result = await cursor.ToListAsync();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual List<T> Find(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
        IAsyncCursor<T> cursor = FindCursor(filter, sort, sortOrder);
        List<T> result = cursor.ToList();
        return result;
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual async Task<List<T>> FindAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    public virtual List<T> Find(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder)
    {
