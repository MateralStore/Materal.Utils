...
public partial interface IMongoRepository<T>
{
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> RangeCursorAsync(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    IAsyncCursor<T> RangeCursor(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
