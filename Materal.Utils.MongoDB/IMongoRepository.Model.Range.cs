...
public partial interface IMongoRepository<T>
{
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="take"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int skip, int take);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="rangeRequestModel"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, RangeRequestModel rangeRequestModel);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<(List<T> data, RangeModel rangeInfo)> RangeAsync(RangeRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    (List<T> data, RangeModel rangeInfo) Range(RangeRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询范围数据
    /// </summary>
    /// <param name="filterModel"></param>
