...
public partial interface IMongoRepository<T>
{
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="pageSize"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, int pageIndex, int pageSize);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="pageRequestModel"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder, PageRequestModel pageRequestModel);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> PagingCursorAsync(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    IAsyncCursor<T> PagingCursor(PageRequestModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询分页数据
    /// </summary>
    /// <param name="filterModel"></param>
