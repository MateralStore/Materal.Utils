...
public partial interface IMongoRepository<T>
{
    ...
    /// <returns></returns>
    Task<IAsyncCursor<T>> FindCursorAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    IAsyncCursor<T> FindCursor(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> FindCursorAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    IAsyncCursor<T> FindCursor(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<IAsyncCursor<T>> FindCursorAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    IAsyncCursor<T> FindCursor(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
}
