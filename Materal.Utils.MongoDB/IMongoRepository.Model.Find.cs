...
public partial interface IMongoRepository<T>
{
    ...
    /// <returns></returns>
    Task<List<T>> FindAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    List<T> Find(FilterDefinition<T> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<List<T>> FindAsync(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filter"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    List<T> Find(Expression<Func<T, bool>> filter, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    Task<List<T>> FindAsync(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
    /// <summary>
    /// 查询数据
    /// </summary>
    /// <param name="filterModel"></param>
    ...
    /// <param name="sortOrder"></param>
    /// <returns></returns>
    List<T> Find(FilterModel filterModel, Expression<Func<T, object>> sort, SortOrder sortOrder);
}
